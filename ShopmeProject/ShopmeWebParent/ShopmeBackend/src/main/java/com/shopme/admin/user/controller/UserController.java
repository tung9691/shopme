...
public class UserController {
	...
	@GetMapping("/users") //ten thymleaf String o file html
	...
	private String getRedirectURLtoAffecttedUser(User user) {
	...
	public String displayRoles(Model model) {
		List<Role> RolesTest = service.listRoles();
		model.addAttribute("RolesTest",RolesTest);
		System.out.println(RolesTest);
		return "index";
	}
	...
	public String createNewUser(Model model) {
		...
		if(!user.isEnable()) {
			model.addAttribute("errormsg", "enable");
		} else {
			model.addAttribute("errormsg", "disable");
		}
	...
	public String deleteUser(@PathVariable(name="id") Integer id, Model model, RedirectAttributes redirectAttribute) {
		try {
			service.delete(id);
			redirectAttribute.addFlashAttribute("message", "User" + id + " has been deleted successfully");
			} 
		catch (UserNotFoundException ex) {
				redirectAttribute.addFlashAttribute("message", ex.getMessage());
			}
